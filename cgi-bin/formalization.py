...
def lr1(form): #пример оформления лабораторнорной
    print("\nФормулировка задачи")
    print('''С использованием браузера отобразить следующую информацию о претенденте: фамилия, год рождения, опыт работы.''')
    ...
    if "last_name" in form and "year_of_birth" in form and "experience" in form:
        try:
            value_tmp = int(form["year_of_birth"].value)
            value_tmp = int(form["experience"].value)
...
print("\n\nСодержание файла с результатами(если необходим)")
print('''\
...
''')
print("\n</pre>")
